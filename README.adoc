...
a parstir de um conjunto de requisitos detalhados na documentação. O diagrama abaixo apresenta as classes existentes. .
...
na pasta src], contendo a mesma documentação disponível no projeto UMLg
